...
function DrawMe(x,y,p1,p2){ var body = document.getElementsByTagName("body")[0]; var canvas = document.createElement('canvas'); body.appendChild(canvas); var ctx = canvas.getContext('2d'); canvas.setAttribute('íd', "canvas"); canvas.setAttribute('width', x); canvas.setAttribute('height', y); ctx.fillStyle = '#FF0000'; ctx.fillRect(p1,p2, 10, 10); }
...
/** @type {function(...*):?} */
var _divi = Module["_divi"] = createExportWrapper("divi");

/** @type {function(...*):?} */
var _mod = Module["_mod"] = createExportWrapper("mod");
